...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/supermario-project/supermario>";
    const std::string URL_WEBSITE = "<https://supermario.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Supermario version %s\n", FormatFullVersion());
}
