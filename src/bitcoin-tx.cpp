...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s supermario-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  supermario-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded supermario transaction") + "\n" +
              "  supermario-tx [options] -create [commands]   " + _("Create hex-encoded supermario transaction") + "\n" +
              "\n";
